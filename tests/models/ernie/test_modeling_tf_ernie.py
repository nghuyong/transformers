...
from transformers import ErnieConfig, is_tf_available
...
if is_tf_available():
    ...
    from transformers.models.ernie.modeling_tf_ernie import (
        TFErnieForMaskedLM,
...
class TFErnieModelTester:
    ...
    def create_and_check_model(
        ...
        model = TFErnieModel(config=config)
    ...
    def create_and_check_causal_lm_model(
        ...
        model = TFErnieLMHeadModel(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_masked_lm(
        ...
        model = TFErnieForMaskedLM(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_next_sequence_prediction(
        ...
        model = TFErnieForNextSentencePrediction(config=config)
        inputs = {"input_ids": input_ids, "attention_mask": input_mask, "token_type_ids": token_type_ids}
        result = model(inputs)
    ...
    def create_and_check_for_pretraining(
        ...
        model = TFErnieForPreTraining(config=config)
        inputs = {"input_ids": input_ids, "attention_mask": input_mask, "token_type_ids": token_type_ids}
        result = model(inputs)
    ...
    def create_and_check_for_sequence_classification(
        ...
        model = TFErnieForSequenceClassification(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_multiple_choice(
        ...
        model = TFErnieForMultipleChoice(config=config)
    ...
    def create_and_check_for_token_classification(
        ...
        config.num_labels = self.num_labels
        model = TFErnieForTokenClassification(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_question_answering(
        ...
        model = TFErnieForQuestionAnswering(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
...
@require_tf
class TFErnieModelTest(TFModelTesterMixin, TFCoreModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        self.model_tester = TFErnieModelTester(self)
    ...
    def test_model_from_pretrained(self):
        model = TFErnieModel.from_pretrained("jplu/tiny-tf-ernie-random")
        self.assertIsNotNone(model)

    def test_model_common_attributes(self):
        config, inputs_dict = self.model_tester.prepare_config_and_inputs_for_common()
        list_lm_models = [TFErnieForMaskedLM, TFErnieForPreTraining, TFErnieLMHeadModel]
    ...
    def test_custom_load_tf_weights(self):
        model, output_loading_info = TFErnieForTokenClassification.from_pretrained(
            "jplu/tiny-tf-ernie-random", output_loading_info=True
        )
...
@require_tf
class TFErnieModelIntegrationTest(unittest.TestCase):
    @slow
    def test_inference_masked_lm(self):
        model = TFErnieForPreTraining.from_pretrained("lysandre/tiny-ernie-random")
