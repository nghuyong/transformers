...
# Copied from transformers.models.bert.modeling_bert.load_tf_weights_in_bert with bert->ernie
...
# Copied from transformers.models.bert.modeling_bert.BertEmbeddings with Bert->Ernie
